/**
 * Create a draft Etsy listing for the International Commerce Centre (ICC),
 * Hong Kong.
 *
 * Real height: 484m. Tapered curtain-wall tower, wf=1.2.
 * Standard 7 tower scales. Mono-colour with 13 colour options.
 *
 * Prices are FIXED (anchored to Shanghai World Financial Center shop pricing —
 * near-identical dimensions), not derived from the raw √weight formula.
 *
 * Dry-run by default. Use --apply to create on Etsy.
 *
 * Usage: npx tsx src/scripts/create-icc.ts [--apply]
 */
...
// ─── Scales + fixed prices (shop-anchored to SWFC) ───────────
...
const TITLE = "International Commerce Centre (ICC) – 3D Printed Skyscraper Model";

const DESCRIPTION =
  "This 3D-printed model of the International Commerce Centre (ICC) captures the tapered glass form of Hong Kong’s tallest building. At 484 metres in real life, ICC anchors the West Kowloon skyline directly opposite Two IFC across Victoria Harbour.\n\n" +
  "The gentle taper and clean curtain-wall surface read well at every scale, making this a versatile centrepiece — and a natural pairing with Two IFC for the full harbour view.";
