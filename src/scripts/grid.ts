...
const BUILDINGS: Record<string, Profile> = {
  ...
  "Ping An Finance Center": { realHeightM: 599, widthFactor: 1.1 },
  "International Commerce Centre": { realHeightM: 484, widthFactor: 1.2 },
  "Two International Finance Centre": { realHeightM: 415, widthFactor: 1.2 },
  "HSBC Main Building": { realHeightM: 178.8, widthFactor: 1.6 },
